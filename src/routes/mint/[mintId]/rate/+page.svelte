...
<div class="flex flex-col max-w-2xl gap-3">
	...
	<div class="form-control">
		<label class="input-group">
			<span>Author</span>
			<input bind:value={author} type="text" placeholder="@someguy" class="input input-bordered w-36" />
		</label>
	</div>
	<div class="form-control">
	...
	<div class="divider">Nuts</div>
	<div class="form-control flex gap-2">
		<label class="input-group">
			<span>Nut</span>
			<input bind:value={nut} type="text" placeholder="cashuAey..." class="input input-bordered" />
		</label>
		<p class="break-all">
			Leaving a review costs <span class="text-secondary"> 4 </span> nuts from the mint
			<a
